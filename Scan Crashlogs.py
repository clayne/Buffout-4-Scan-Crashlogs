...
print("Hello World! | Crash Log Auto-Scanner | Version 4.10 | Fallout 4")
...
drives = ["C:","D:","E:","F:","G:"]
for drive in drives:
    if os.path.exists(drive+User_Path+"\Documents\My Games\Fallout4"):
        FO4_Custom_Path = drive+User_Path+"\Documents\My Games\Fallout4\Fallout4Custom.ini"
        FO4_INI_Path = drive+User_Path+"\Documents\My Games\Fallout4\Fallout4.ini"
...
#DEFINE SPECIFIC FILES TO LOOK FOR HERE (NEEDS r BECAUSE UNICODE ERROR)
...
for file in os.listdir("."):
    if fnmatch.fnmatch(file, "crash-*.log"): #(RESERVED) or fnmatch.fnmatch(file, "crash-*.txt")
        ...
        print("VER 4.10 | MIGHT CONTAIN FALSE POSITIVES.")
        print("====================================================")
