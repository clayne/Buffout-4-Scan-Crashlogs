...
for file in inputfiles:
    ...
    with file.open("r", encoding="utf-8", errors="ignore") as f:
        ...
        if b4_ver.casefold() != b4_latest.casefold():
            print(f"Skipping this log because it was not generated with {b4_latest}")
            continue
    ...
    if not commandline.json and not outpath.exists():
        with outpath.open("a", encoding="utf-8", errors="ignore") as w:
            ...
            """Config File Checks"""
            if (datadict["B4Achievements"] >= 1 and datadict["AchivementsDLL"] >= 1) or (datadict["B4Achivements"] >= 1 and datadict["UnlimitedSurvivalMode"] >= 1):
                w.write(
            ...
            if datadict["B4MemoryManagement"] >= 1 and datadict["Baka"] >= 1:
            ...
            if datadict["B4LMCompat"] >= 1 and datadict["LMPlugin"] >= 1:
            ...
            if datadict["X3DAudio1_7"] >= 2 or datadict["XAudio2_7"] >= 2:
                w.write(
